...
<img style="float: left; padding: 0px 10px 0px 0px;" src="www/tidyverse_space.jpg" width="300" height="300"/>
...
### `r fa("fas fa-meteor", fill = "purple")` Reshape with `pivot_longer()` and `pivot_wider()`
